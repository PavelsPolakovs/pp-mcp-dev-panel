...
- options:
  ...
  3. label "Complete task"    — description "Develop and complete the current task using the Frontend agent"
  4. label "Quality checks"   — description "Run Prettier, ESLint, Typecheck, and Build across all www/ projects"
  5. label "Run tests"        — description "Run Jest unit/component tests across all www/ projects"
  6. label "Commit and push"  — description "Stage changes, commit with a conventional message, and push to the remote branch"
  7. label "Merge branch"     — description "Open a merge request and merge the branch into main"
  8. label "Close issue"      — description "Close the task linked to the session and mark it as resolved"
  9. label "Metrics"           — description "View and analyze Claude API token usage for the current task lifecycle"
  10. label "Back"            — description "Return to the Start Menu"
```
...
9. **Metrics**
   a. Load `.a-local-workflow/workflow/metrics/index.md` and transfer control to the **Metrics Menu**.
