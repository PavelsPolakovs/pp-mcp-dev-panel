...
export const NAV_CONFIG: NavSection[] = [
  {
    ...
    items: [
      { key: 'dashboard', labelKey: 'nav.items.dashboard', path: '/dashboard', icon: LayoutDashboard },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'orders', labelKey: 'nav.items.orders', path: '/orders', icon: ShoppingCart, badge: 5 },
  ...
  },
  {
    ...
    items: [
      { key: 'integrations', labelKey: 'nav.items.integrations', path: '/integrations', icon: Plug2 },
