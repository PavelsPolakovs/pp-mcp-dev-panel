...
- Use PascalCase for component filenames (e.g., `ThemeButton.jsx`).
- Co-locate component-specific styles or assets with the component file if needed.
- Add an `index.js` file for barrel exports if the folder contains multiple components.

## Example
- `atoms/ThemeButton.jsx`
- `molecules/CommandButton.jsx`
